...
public class EditContact {
	...
	public static void main(String[] args) {
      ...
      WebElement edit= driver.findElement(By.linkText("Edit"));
       ...
       updatecompany.sendKeys("updatecompany");

       WebElement update = driver.findElement(By.xpath("//input[@name='submitButton']"));
       update.click();
       
       WebElement updatecompanyvalue = driver.findElement(By.xpath("//span[contains[text(),'updatecompany']"));
       updatecompanyvalue.getText();
